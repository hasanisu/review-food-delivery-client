...
const Contact = () => {
  return (
   <div className="mb-20 mt-10 lg:pt-24 lg:pb-24">
	...
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
		<div className="py-6 md:py-0 md:px-6">
			...
			<div className="space-y-4">
				<p className="flex items-center">
					...
					<span>Aoto, Katsushika, Tokyo, Japan</span>
				</p>
				<p className="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
				...
				<p className="flex items-center">
					...
					<span>service@delivery.com</span>
				</p>
			</div>
		</div>
		<form novalidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
			...
			<button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ri basic dark:text-gray-900 focus:ri hover:ri">Submit</button>
		</form>
	</div>
</section>
   </div>
